...
from projects.models import Project, status_choices, level_choices, size_choices, speed_choices, type_choices, \
...
class EditProjectForm(ModelForm):
    class Meta:
        model = Project
        exclude = ['author', 'project_start_date','project_spent_money']
        labels = {
            'project_curator': 'Loyiha kuratori',
            'project_manager': 'Loyiha menejeri(lari)',
            'project_name': 'Loyiha nomi',
            ...
            'project_type': 'Turi',
            'project_team': 'Biriktirilgan users',
